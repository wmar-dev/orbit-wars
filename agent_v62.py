"""
Orbit Wars - agent_v62 (best4 config)

70% vs v61 (50 games, --swap), built on agent_v60 beam search (Kaggle 916.9).

Four independently-togglable experiments, three passing:
  ...
  PASS  DYNAMIC_GARRISON_ENABLED   — lower garrison cap 2.5x/400t (67.5% vs v60, from v61)

Discarded (no benefit vs v60):
  MULTI_DISPATCH_ENABLED = False   — 50% vs v60, no improvement
  THREAT_BUFFER_ENABLED  = False   — 40% vs v60, negative
"""
