"""
Orbit Wars - Experiment 013 scoring-2: production-first scoring
Base: agent_v38. Change: _roi() replaced with prod / (ships + 1) — ignores distance.
...
def _roi(t, bx, by, mine):
    return t.production / max(1.0, t.ships + 1)
