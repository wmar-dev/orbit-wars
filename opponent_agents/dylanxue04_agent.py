# Source: dylanxue04
"""
Orbit Wars - Stellar Nexus Agent v5
All-notebook fusion: v4 base + max-1224 exposed/blood-in-water/total-war
+ Structured-v6 rescue/recapture + crash exploit + let-them-fight.

Key v5 additions over v4:
  1. Exposed planet detection (enemy sent 80%+ fleet out)
  2. Blood in the Water - FFA elimination bonus for weak enemies
  3. Let Them Fight - penalty when 2+ enemies contest a neutral
  4. Total War endgame mode (halve reserves at <42 turns left)
  5. Crash exploit - delayed follow-up after enemy crashes at neutral
  6. Weakest enemy targeting bonus in 4P
  7. Adaptive send margins for exposed planets
  8. Parameter tuning from LB max-1224
"""
