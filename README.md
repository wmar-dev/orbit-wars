...
| **`agent_v58.py`** | **Candidate B: multi-planet dispatch — remove single-sender serialization; each planet finds its own best ROI target independently** | **Kaggle best: 842.0** |
...
| `agent_v60.py` | Lookahead beam search: evaluate top-K alternative targets per mine N turns forward before committing; SEARCH_STRATEGY=beam, SEARCH_DEPTH=10, BEAM_K=3 | 54% vs v58 (50 games); Kaggle score TBD |
