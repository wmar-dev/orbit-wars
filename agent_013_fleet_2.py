"""
Orbit Wars - Experiment 013 fleet-2: production-buffered fleet sizing
Base: agent_v38. Change: ships_needed += production * ceil(travel_turns) to cover accrual.
...
def agent(obs):
    ...
    for mine in my_planets:
        ...
        # fleet-2: add production accrual buffer
