"""
Orbit Wars - agent_v58_fallback

Fix: Affordability fallback in targeting loop with garrison and quality guards.
...
Example: at step 6, Planet 16 (ROI=27.20, need=31) was unaffordable with 22 ships.
Planet 8 (ROI=20.38, need=19) was affordable but never reached. The mine skipped
6 turns waiting for Planet 16 while the opponent captured 2 planets.
...
Fix: Sort candidates by blended ROI descending, iterate until finding one that:
  ...
  (b) has blended score >= FALLBACK_MIN_RATIO of the best candidate's score.
Guard (b) prevents chasing cheap low-quality planets just because they're affordable
(e.g., a 12-ship 1-growth planet when the best is a 30-ship 5-growth planet).
